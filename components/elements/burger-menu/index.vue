<template>
  <div
    ...
    class="toggle-menu d-block d-sm-block d-md-none ml-auto p-1"
  >
    <div class="hamburger">
      <span
        class="hamburger-slice top"
        :class="isOpen ? 'top-anim bg-light' : 'top-anim-r'"
      ></span>
      <span
        class="hamburger-slice mid"
        :class="isOpen ? 'mid-anim bg-light' : 'mid-anim-r'"
      ></span>
      <span
        class="hamburger-slice bot"
        :class="isOpen ? 'bot-anim bg-light' : 'bot-anim-r'"
      ></span>
    </div>
  </div>
</template>
