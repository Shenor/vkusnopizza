<template>
  <b-modal id="modal-code" title="Вход на сайт" centered>
    <template #default>
      ...
      <b-container v-if="!isSendCode" class="text-center">
        <form ref="form" @submit.stop.prevent="">
          <b-form-group label="Номер телефона" label-for="phone-input">
            <the-mask
              id="phone-input"
      ...
      <b-container>
        <b-alert v-if="error" show class="w-100" variant="danger">
          <small>
            {{ error }}
          </small>
        </b-alert>
