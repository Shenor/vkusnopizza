          ...
          <div class="order__body-wrapper d-flex flex-column text-left col col-lg-8 col-md-7 col-sm-12">
            ...
            <div class="order__body">
              ...
              <div v-show="!isSelfService">
                ...
                <div class="order__body__address mb-4">
                  <b-form-group
                    :state='streetState'
                    label-for="street"
                    invalid-feedback="Данная улица не найдена">
                    <b-form-input class="pt-3 pb-3 mb-2" id="street" :class="{'is-invalid': $v.street.$error }" v-model.trim="$v.street.$model" placeholder="Введите улицу" autocomplete="off"></b-form-input>
                  </b-form-group>
                  <div class="d-flex">
                    <b-form-input class="pt-3 pb-3 mr-2" :class="{'is-invalid': $v.home.$error }" v-model.trim="$v.home.$model" placeholder="Дом"></b-form-input>
                    <b-form-input class="pt-3 pb-3 mr-2" placeholder="Подъезд" v-model.trim="entrance"></b-form-input>
                    <b-form-input class="pt-3 pb-3"  placeholder="Квартира"  v-model.trim="apartment"></b-form-input>
                  </div>
                </div>
              </div>
            ...
            <div class="order__footer">
              ...
              <div class="order__footer__btn-action d-flex px-3 py-2 mb-2" :class="[loading ? 'justify-content-center':'justify-content-between']" @click="submit">
